...
(function( root, factory ) {
	...
	function updateBackgroundOpacity(slide, fragmentVisibilityChanged) {
		var backgroundImage = slide.getAttribute( 'data-background-image' );
		if (backgroundImage && fragmentVisibilityChanged) {
				dom.background.style.opacity = 0.3;
		} else {
	...
	function navigateFragment( index, offset ) {
		...
		if( currentSlide && config.fragments ) {
			...
			if( fragments.length ) {
				...
				updateControls();
				updateProgress();
				updateBackgroundOpacity(currentSlide, ( fragmentsShown.length || fragmentsHidden.length ));
		...
		updateBackgroundOpacity(currentSlide);
